const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/map-vendor.Dz2XYzxS.js","assets/react-vendor.CAU3V3le.js","assets/ui-vendor.DoN6OTIp.js"])))=>i.map(i=>d[i]);
...
import { o as ue } from './index.B1pZJRDR.js';
...
const SimpleClickMap = ({
  ...
  const initMap = reactExports.useCallback(async () => {
    ...
    try {
      const L = await __vitePreload(() => import('./map-vendor.Dz2XYzxS.js').then(n => n.l),true?__vite__mapDeps([0,1,2]):void 0);
      LRef.current = L;
