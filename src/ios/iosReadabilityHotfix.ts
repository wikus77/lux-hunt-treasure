...
#m1-modal-portal,.m1-reward-zone-popup,[data-radix-dialog-content],[data-radix-alert-dialog-content],[data-radix-popover-content],[data-radix-select-content],[data-vaul-drawer],.settings-modal { color: rgba(255,255,255,0.92) !important; -webkit-text-fill-color: rgba(255,255,255,0.92) !important; }
...
[data-radix-dialog-content] .text-foreground,[data-radix-dialog-content] [class*="text-foreground"]:not([class*="muted"]),[data-radix-alert-dialog-content] .text-foreground,[data-radix-alert-dialog-content] [class*="text-foreground"]:not([class*="muted"]),[data-radix-popover-content] .text-foreground,[data-radix-popover-content] [class*="text-foreground"]:not([class*="muted"]),[data-radix-select-content] .text-foreground,[data-radix-select-content] [class*="text-foreground"]:not([class*="muted"]),[data-vaul-drawer] .text-foreground,[data-vaul-drawer] [class*="text-foreground"]:not([class*="muted"]),.settings-modal .text-foreground,.settings-modal [class*="text-foreground"]:not([class*="muted"]) { color: #ffffff !important; -webkit-text-fill-color: #ffffff !important; }
/* placeholder */
...
[data-radix-dialog-content] input::placeholder,[data-radix-dialog-content] textarea::placeholder,[data-radix-alert-dialog-content] input::placeholder,[data-radix-alert-dialog-content] textarea::placeholder,[data-radix-popover-content] input::placeholder,[data-radix-popover-content] textarea::placeholder,[data-radix-select-content] input::placeholder,[data-radix-select-content] textarea::placeholder,[data-vaul-drawer] input::placeholder,[data-vaul-drawer] textarea::placeholder,.settings-modal input::placeholder,.settings-modal textarea::placeholder { color: rgba(255,255,255,0.48) !important; -webkit-text-fill-color: rgba(255,255,255,0.48) !important; }
/* disabled */
...
[data-radix-dialog-content] input:disabled,[data-radix-dialog-content] textarea:disabled,[data-radix-alert-dialog-content] input:disabled,[data-radix-alert-dialog-content] textarea:disabled,[data-radix-popover-content] input:disabled,[data-radix-popover-content] textarea:disabled,[data-radix-select-content] input:disabled,[data-radix-select-content] textarea:disabled,[data-vaul-drawer] input:disabled,[data-vaul-drawer] textarea:disabled,.settings-modal input:disabled,.settings-modal textarea:disabled { opacity: 1 !important; color: rgba(255,255,255,0.70) !important; -webkit-text-fill-color: rgba(255,255,255,0.70) !important; filter: none !important; }
`;
