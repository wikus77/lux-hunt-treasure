...
const XavierStyleLandingPage = ({ onRegisterClick, openInviteFriend }: XavierStyleLandingPageProps) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Sections parallax and reveal animations
      ...
      if (backgroundRef.current) {
        gsap.to(backgroundRef.current, {
          background: "radial-gradient(circle at 50% 50%, #1a003a 0%, #0f043a 50%, #10182f 100%)",
          duration: 3,
          repeat: -1,
          yoyo: true,
          ease: "power2.inOut"
  ...
  return (
    <SmoothScroll>
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div 
          ref={backgroundRef}
          className="fixed inset-0 bg-gradient-to-br from-purple-900 via-black to-blue-900 opacity-80"
          style={{
            background: "radial-gradient(circle at 30% 70%, #1a003a 0%, #0f043a 50%, #10182f 100%)"
          }}
        />
