  ...
  return (
    <footer ref={footerRef} className="relative py-20 bg-black border-t border-gray-800">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-cyan-500 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg hover:shadow-xl z-50"
      >
