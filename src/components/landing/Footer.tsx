...
const MinimalFooter = () => {
  ...
  return (
    <footer ref={footerRef} className="relative py-20 bg-background border-t border-border/50">
      {/* Gradient overlay */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-medium text-foreground mb-6">Platform</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-lg font-medium text-foreground mb-6">Company</h4>
            <ul className="space-y-4">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary text-primary-foreground rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg hover:shadow-xl z-50"
      >
