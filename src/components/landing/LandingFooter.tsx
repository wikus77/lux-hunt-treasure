      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full mb-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-end">
            ...
            <Link to="/termini-e-condizioni" className="text-base text-white/80 hover:text-cyan-400 transition-colors font-medium px-2 py-1">Termini e Condizioni</Link>
            <Link to="/contatti" className="text-base text-white/80 hover:text-cyan-400 transition-colors font-medium px-2 py-1">Contatti</Link>
          </div>
        </div>
