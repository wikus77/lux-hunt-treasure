...
import { Mail, Map, Home, Award, User, Circle, Gamepad2, ExternalLink } from "lucide-react";
...
const BottomNavigation = () => {
  ...
  const links = [
    { icon: <Home className="h-6 w-6" />, label: "Home", path: "/home" }, // CORRETTO: PUNTA ALL'APP HOME INTERNA, NON ALLA LANDING
    ...
    // Aggiunta separata per Landing Page esterna
    { 
      icon: <ExternalLink className="h-6 w-6" />, 
      label: "Landing", 
      path: "https://www.m1ssion.com",
      isExternal: true
    },
  ];
        ...
        {links.map((link) => (
          link.isExternal ? (
            <div
              ...
              className="relative flex flex-col items-center justify-center w-16 h-16 transition-colors mobile-touch-target text-gray-400 hover:text-gray-300 cursor-pointer"
            >
