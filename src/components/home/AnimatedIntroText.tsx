...
export default function AnimatedIntroText() {
  return (
    <div className="glass-card px-8 py-7 rounded-2xl max-w-2xl text-lg md:text-xl text-center shadow-lg flex flex-col gap-2"
      style={{
    ...
    >
      {LINES.map((line, idx) => (
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.3 + idx*0.24 }}
        >
          <span
