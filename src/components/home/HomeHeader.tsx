...
const HomeHeader = ({ profileImage, unreadCount, onShowNotifications }: HomeHeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 pt-[env(safe-area-inset-top)] min-h-[calc(44px+env(safe-area-inset-top))] backdrop-blur-md bg-gradient-to-r from-black/80 to-black/80 border-b border-projectx-deep-blue/30 header-safe-area">
