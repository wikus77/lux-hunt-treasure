...
// 🎬 Settings Overlay - iOS WKWebView OPTIMIZED (identico a AgentProfileFlipOverlay)
...
export const SettingsFlipOverlay: React.FC<SettingsFlipOverlayProps> = ({
  ...
  const getOrigin = () => {
    ...
    if (!rect) return { x: '85%', y: '5%' }; // Fallback top-right
...
export default SettingsFlipOverlay;
