      ...
      <div className="luxury-cars-showcase bg-black/50 p-6 rounded-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-4">
          <div className="text-center">
            <div className="car-logo-container ferrari-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
          ...
          <div className="text-center">
            <div className="car-logo-container lambo-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
          ...
          <div className="text-center">
            <div className="car-logo-container porsche-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
          ...
          <div className="text-center">
            <div className="car-logo-container mclaren-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
          ...
          <div className="text-center">
            <div className="car-logo-container aston-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
          ...
          <div className="text-center">
            <div className="car-logo-container mercedes-logo-container mx-auto rounded-full flex items-center justify-center mb-2">
              <img 
