...
// 🎬 Notification Category Overlay - iOS WKWebView OPTIMIZED
import React, { useEffect, useState, useCallback, useRef } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { createPortal } from 'react-dom';

interface NotificationCategoryFlipOverlayProps {
  open: boolean;
...
export const NotificationCategoryFlipOverlay: React.FC<NotificationCategoryFlipOverlayProps> = ({
  open,
  originRect,
  onClose,
  children
  ...
  // Create portal
  useEffect(() => {
    let container = document.getElementById('m1-notifcategory-portal');
    if (!container) {
      container = document.createElement('div');
      container.id = 'm1-notifcategory-portal';
...
export default NotificationCategoryFlipOverlay;
