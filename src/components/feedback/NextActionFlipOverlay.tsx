...
// 🎬 Next Action Overlay - iOS WKWebView OPTIMIZED (identico agli altri)
import React, { useEffect, useState, useCallback, useRef } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { createPortal } from 'react-dom';

interface NextActionFlipOverlayProps {
  open: boolean;
...
export const NextActionFlipOverlay: React.FC<NextActionFlipOverlayProps> = ({
  open,
  originRect,
  onClose,
  children
  ...
  // Create portal
  useEffect(() => {
    let container = document.getElementById('m1-nextaction-portal');
    if (!container) {
      container = document.createElement('div');
      container.id = 'm1-nextaction-portal';
...
export default NextActionFlipOverlay;
