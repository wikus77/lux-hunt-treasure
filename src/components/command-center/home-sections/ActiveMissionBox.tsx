          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">{mission.foundClues}/{mission.totalClues} scoperti</p>
              </div>
            </div>
            <motion.div
            ...
            >
              <ChevronDown className="w-5 h-5 text-[#00D1FF]" />
            </motion.div>
          </div>
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">{mission.remainingDays} giorni rimasti</p>
              </div>
            </div>
            <motion.div
                  ...
                  <div className="pt-4 space-y-3">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-amber-400">{formatTime(mission.timeLimit)}</p>
                        <p className="text-sm text-white/60">Tempo limite</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-[#00D1FF]">{mission.remainingDays}</p>
                  ...
                  <div className="pt-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-[#0a0a0a] p-3 rounded-lg text-center">
                        <p className="text-xl font-bold text-green-400">{mission.foundClues}</p>
                        <p className="text-xs text-white/60">Obiettivi Raggiunti</p>
                      </div>
                      <div className="bg-[#0a0a0a] p-3 rounded-lg text-center">
                        <p className="text-xl font-bold text-red-400">{mission.totalClues - mission.foundClues}</p>
