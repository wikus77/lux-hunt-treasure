export const PORTALS_SEED = [
  ...
  { id: 'p_bali', name: 'Portal – Bali', lat: -8.3405, lng: 115.0920 },
  { id: 'p_png', name: 'Portal – PNG', lat: -6.314993, lng: 143.95555 },
  { id: 'p_madrid', name: 'Portal – Madrid', lat: 40.4168, lng: -3.7038 },
  { id: 'p_milan', name: 'Portal – Milan', lat: 45.4642, lng: 9.1900 },
  { id: 'p_nice', name: 'Portal – Nice', lat: 43.7102, lng: 7.2620 },
