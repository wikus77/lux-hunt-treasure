...
const InterestAreasGrid: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="relative rounded-2xl shadow-md border border-white/10 bg-gradient-to-br from-[#1c1e27] via-[#1e1f2b] to-[#14151d] px-6 py-4 md:px-6 md:py-5 text-white font-sans text-base tracking-wide overflow-hidden">
