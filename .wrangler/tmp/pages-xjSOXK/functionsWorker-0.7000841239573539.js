...
function parseStripeSigHeader(sig) {
  if (!sig) return null;
  let t = "";
  const v1s = [];
...
// ../.wrangler/tmp/pages-xjSOXK/functionsRoutes-0.8115777872230141.mjs
var routes = [
  {
...
// ../../.nvm/versions/node/v20.18.1/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../.nvm/versions/node/v20.18.1/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
