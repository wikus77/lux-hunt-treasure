const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/map-vendor.uCr1tAyj.js","assets/animation-vendor.BiI6PE8T.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, m as ue } from './index.CUdqZWfi.js';
...
const SimpleClickMap = ({
  ...
  const initMap = reactExports.useCallback(async () => {
    ...
    try {
      const L = await __vitePreload(() => import('./map-vendor.uCr1tAyj.js').then(n => n.l),true?__vite__mapDeps([0,1]):void 0);
      LRef.current = L;
