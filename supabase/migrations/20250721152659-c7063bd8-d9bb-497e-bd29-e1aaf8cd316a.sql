-- Complete Mission Reset Fix - Update countdown calculation to use database mission_started_at
-- © 2025 Joseph MULÉ – M1SSION™ – ALL RIGHTS RESERVED – NIYVORA KFT™

-- First, ensure the reset_user_mission_full function explicitly updates mission_started_at to NOW()
DROP FUNCTION IF EXISTS public.reset_user_mission_full(uuid);
