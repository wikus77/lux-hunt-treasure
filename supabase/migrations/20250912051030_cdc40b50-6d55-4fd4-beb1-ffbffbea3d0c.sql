-- Mirror Push Audit Schema Migration - Correzione Finale Struttura
...
-- 2) Drop e ricrea sync_watermarks con struttura corretta
DROP TABLE IF EXISTS mirror_push.sync_watermarks CASCADE;
...
-- 3) Adatta tabella notification_logs esistente alla struttura target
DO $$
BEGIN
