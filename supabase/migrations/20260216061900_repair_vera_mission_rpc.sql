...
-- REPAIR: Create start_vera_mission_run + finalize_vera_mission_run if missing (PGRST202)
-- Idempotent: CREATE OR REPLACE. Run if main migration 20260215 was partially applied.
-- Requires: vera_mission_runs, vera_mission_attempts, award_pulse_energy exist.
