...
-- Fix critico: Trigger auth.users → profiles + plan values corretti

-- 1. Inserisci manualmente il profilo mancante per dev.wikus77@hotmail.it con plan 'base'
...
-- 2. Ricreo completamente la funzione handle_new_user con plan 'base'
