-- M1SSION™ Critical Database Cleanup and Force Sync
-- © 2025 Joseph MULÉ – M1SSION™ – ALL RIGHTS RESERVED – NIYVORA KFT™

-- 1. Enhanced cleanup function with force update
...
-- 2. Enhanced cleanup function that removes duplicates more aggressively
...
-- 3. Force the current user to Base tier
SELECT public.force_user_to_base_tier('495246c1-9154-4f01-a428-7f37fe230180');

-- 4. Clean up all duplicates system-wide
