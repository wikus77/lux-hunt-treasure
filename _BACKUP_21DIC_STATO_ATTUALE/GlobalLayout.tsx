...
const GlobalLayout: React.FC<GlobalLayoutProps> = ({ children }) => {
  ...
  // MapTiler3D gestisce la sua BottomNavigation con wrapper speciale
  const selfManagedRoutes: string[] = ['/map-3d-tiler'];
  ...
  if (isFullScreen) {
    return (
      <SafeAreaWrapper className="min-h-screen" style={{ position: 'relative', zIndex: 1 }}>
