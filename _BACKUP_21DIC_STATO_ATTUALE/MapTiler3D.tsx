...
import { MicroMissionsCard, IdlePopup, MICRO_MISSIONS_ENABLED } from '@/components/micro-missions';
...
// 🎯 DISCOVERY: First session guided discovery overlays
import { MapHUDOverlay, MicroMissionOverlay, BuzzHelpPopup, MicroMissionCard, DISCOVERY_MODE_ENABLED, MICRO_MISSIONS_ENABLED } from '@/components/discovery';
...
export default function MapTiler3D() {
  ...
  return (
    <FinalShootProvider>
      ...
      {/* 🎯 DISCOVERY: First session guided overlays */}
      {DISCOVERY_MODE_ENABLED && (
        <>
          <MapHUDOverlay />
          <MicroMissionOverlay mapContainerId="ml-sandbox" />
          <BuzzHelpPopup />
        </>
      )}
      
      {/* 🎯 MICRO-MISSIONS: Visible guided actions card */}
      {MICRO_MISSIONS_ENABLED && (
        <MicroMissionCard mapContainerId="ml-sandbox" />
      )}
      ...
      {/* 🎯 MICRO-MISSIONS: Guided discovery system (feature-flagged) */}
      {MICRO_MISSIONS_ENABLED && (
        <>
          <MicroMissionsCard mapContainerId="ml-sandbox" />
          <IdlePopup mapContainerId="ml-sandbox" />
        </>
      )}
    </FinalShootProvider>
  );
