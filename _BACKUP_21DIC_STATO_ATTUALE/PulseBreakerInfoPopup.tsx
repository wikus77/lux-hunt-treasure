...
const POPUP_ID = 'pulse-breaker-popup';
  ...
  useEffect(() => {
    ...
    const attemptShow = () => {
      if (!canShowPopup(POPUP_ID)) {
        console.log('[PulseBreakerPopup] ⏳ Queue busy, waiting for unlock...');
        return false;
      }
    ...
    console.log('[PulseBreakerPopup] 🎮 Popup will attempt to show in 2 minutes...');
