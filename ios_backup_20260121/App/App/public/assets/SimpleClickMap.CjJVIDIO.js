const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/map-vendor.DftgD3cK.js","assets/react-vendor.FGvtrp7q.js","assets/ui-vendor.sKtoNQj2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, m as ue } from './index.C8SyQ7Ep.js';
...
const SimpleClickMap = ({
  ...
  const initMap = reactExports.useCallback(async () => {
    ...
    try {
      const L = await __vitePreload(() => import('./map-vendor.DftgD3cK.js').then(n => n.l),true?__vite__mapDeps([0,1,2]):void 0);
      LRef.current = L;
