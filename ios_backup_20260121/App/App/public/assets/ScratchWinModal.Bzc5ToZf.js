...
import { cg as useNotifications, G as Gift, X, a1 as LoaderCircle, S as Sparkles, e as CircleAlert, s as supabase, H as confetti, m as ue } from './index.C8SyQ7Ep.js';
  ...
  const handleReveal = async () => {
    ...
    try {
      ...
      if (rewardType === "m1u" && rewardValue > 0) {
        ...
        ue.success("🔍 Hai vinto un INDIZIO!", {
        ...
        ue.info("Risultato in elaborazione...", {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg", children: "SCRATCH & WIN" }),
              ...
              children: [
                ...
                isRevealed && result && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-black/70 rounded-lg z-10", children: result.rewardType === "m1u" && result.rewardValue > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      result.isJackpot && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-bold text-white mb-2", children: "HAI VINTO UN INDIZIO!" }),
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-bold text-white/80", children: "Nessuna vincita" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mt-2 text-sm", children: "Ritenta!" })
                    ]
                  }
                ) })
              ]
