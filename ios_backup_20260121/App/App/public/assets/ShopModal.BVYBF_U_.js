...
const FortuneWheel = reactExports.lazy(() => __vitePreload(() => import('./index.C8SyQ7Ep.js').then(n => n.cP),true?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
const ScratchWinModal = reactExports.lazy(() => __vitePreload(() => import('./ScratchWinModal.Bzc5ToZf.js'),true?__vite__mapDeps([9,1,2,0,3,4,5,6,7,8]):void 0));
const LotteryContent = reactExports.lazy(() => __vitePreload(() => import('./LotteryContent.BQcgUY61.js'),true?__vite__mapDeps([10,1,2,0,3,4,5,6,7,8,11]):void 0));
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-white/10", children: [
              { id: "scratch", label: "Scratch & Win", color: "from-yellow-500 to-amber-600" },
              { id: "wheel", label: "Gira la Ruota", color: "from-green-500 to-emerald-600", badge: canSpinWheel },
              { id: "lottery", label: "Lotteria", color: "from-blue-500 to-cyan-600" }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 overflow-y-auto flex-1", children: [
                ...
                isLoadingStats ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-8 h-8 text-purple-400 animate-spin" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", children: [10, 30, 50].map((tier) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.button,
                    {
                      ...
                      children: [
                        tierData?.jackpot_available && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 text-[10px] font-bold bg-gradient-to-r from-yellow-500 to-orange-500 text-black rounded-full animate-pulse", children: "🎰 JACKPOT" }) }),
              ...
              activeTab === "wheel" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-8", children: [
                ...
                canSpinWheel ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2", children: "Giro GRATUITO disponibile!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mb-6", children: "Gira la ruota e vinci M1U ogni giorno" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.button,
                    {
