...
import { aC as Trophy, S as Sparkles, af as Clock, x as useUnifiedAuth, s as supabase, a1 as LoaderCircle, A as TriangleAlert, X, G as Gift, a3 as Plus, m as ue } from './index.C8SyQ7Ep.js';
import { m as motion, A as AnimatePresence } from './animation-vendor.BT4oAzOt.js';
import { T as Ticket, M as Minus } from './ticket.0KQdAoe7.js';
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-4 pb-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between", children: [
                ...
                isWinner ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-black/20", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-cyan-400", children: "LOTTERIA" })
                ] })
              ] })
            ] }),
...
const LotteryContent = ({ balance, onBalanceUpdate }) => {
  ...
  if (!status) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm", children: "La prossima lotteria inizierà presto!" })
    ] });
  }
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-r from-yellow-500/20 to-amber-600/20 p-6 text-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-white", children: "🎉 HAI VINTO! 🎉" }),
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm mt-1", children: "Buona fortuna!" })
              ] }),
